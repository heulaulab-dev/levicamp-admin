	...
	return (
		...
		>
			{asChild ? (
				...
				<>
					<span className='group-data-[loading=true]/step:opacity-0 group-data-[state=completed]/step:opacity-0 group-data-[loading=true]/step:scale-0 group-data-[state=completed]/step:scale-0 transition-all group-data-[loading=true]/step:transition-none'>
						{step}
					</span>
					<CheckIcon
